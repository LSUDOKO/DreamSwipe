...
export default function GameChat() {
  ...
  return (
    <div className="flex h-full flex-col font-pixel text-white">
      ...
      <div
        ref={scrollRef}
        className="flex flex-1 flex-col gap-3 overflow-y-auto [mask-image:linear-gradient(to_bottom,transparent_0%,black_6%,black_100%)] px-4 pb-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
        {messages.length === 0 ? (
          <Empty />
        ) : (
